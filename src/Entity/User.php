...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getArePreferencesEmpty(): ?bool
    {
        return $this->are_preferences_empty;
    }

    public function setArePreferencesEmpty(bool $are_preferences_empty): self
    {
        $this->are_preferences_empty = $are_preferences_empty;
